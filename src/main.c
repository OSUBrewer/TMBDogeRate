...
void handle_init(void) {
	...
	legend_layer_units = text_layer_create(GRect(143, 167, 144, 168)); /*GRect(40, 3, 144-40-10, 20)*/
	...
	legend_layer_doge = text_layer_create(GRect(143, 167, 144, 168));  /*GRect(40, 24, 144-40-10, 20) */
	...
	dogecoin_layer = text_layer_create(GRect(10, 3, 144-7, 168-3)); /*GRect(7, 3, 55-7, 168-3)*/
	text_layer_set_font(dogecoin_layer,
					   fonts_load_custom_font(resource_get_handle(RESOURCE_ID_COMIC_SANS_BOLD_21)));
	...
	GRect line_frame = GRect(1, 1, 168, 1); /* GRect(58, 23, 115-58, 2)*/
